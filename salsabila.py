buku = [
 "{0.pintar C++, harga : 30000}",
 "{1. pintar python, harga :20000}", 
 "{2. pintar programer, harga : 250000}", 
 "{3. Desaign Website, harga : 40000}", 
 "{4. pintar Network, Harga : 35000}"]
...
if a == 1:
    ...
    if b in ["ya", "YA", "Ya"]:
        ...
        if pilih == 0:
            ...
            print("====================================================")
            tanya =str(input("apakah masih beli buku, jika masi masukan nomor buku, jika tidak, tuliskan tidak :"))
            if tanya == "1":
                harga = 50000
                jum = 2
                print("============================================")
    ...
    print("selamat datang admin pada aplikasi penjualan buku  pada Toko permata sari")
    print("--------------------------------------------------------------------")
    print("stok buku")
    print(buku)
    print("===================================================================")
